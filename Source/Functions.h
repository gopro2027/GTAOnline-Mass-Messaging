...
void sendTextToPlayerAnonymous(char *message, int *networkStruct, int messageIndex = 3);
void sendEmailToPlayerAnonymous(char *subject, char *message, int *networkStruct, int messageIndex = 3);
...
extern bool dontSendOnlyFind;

extern int var1;
extern float var2;
extern float var3;
extern float var4;
extern char *messageSendText;
extern bool useRockstarName;
extern char *sValue;
extern int iValue;
extern bool useMarketing;


void appendInFile(char * fmt, ...);//from menu.cpp
char *appendInFile2(char * fmt, ...);//from menu.cpp
